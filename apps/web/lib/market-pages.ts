...
export const MARKET_UI: Record<string, {
  ...
  tr: {
    ...
    trust_badges: ['🔒 SSL Güvenli', '⚡ 3 Gün Ücretsiz', '🚫 Kart Gerekmez', '✅ İstediğin an iptal'],
    privacy: 'Gizlilik Politikası', terms: 'Kullanım Şartları',
    copyright: 'Tüm hakları saklıdır.',
    cta_sub: '3 gün ücretsiz deneyin. Kredi kartı gerekmez. İstediğiniz zaman iptal edin.',
    features_title: 'Neden Sovlo AI?',
    ...
    cta_desc: '3 gün ücretsiz deneyin. Kredi kartı gerekmez. İstediğiniz zaman iptal edin.',
    per_month: '/ay',
  ...
  ru: {
    ...
    features_title: 'Почему Sovlo AI?',
  ...
  en: {
    ...
    trust_badges: ['🔒 SSL Secure', '⚡ 3 Days Free', '🚫 No Credit Card', '✅ Cancel Anytime'],
    privacy: 'Privacy Policy', terms: 'Terms of Service',
    copyright: 'All rights reserved.',
    cta_sub: 'Start free for 3 days. No credit card required. Cancel anytime.',
    features_title: 'Why Sovlo AI?',
    ...
    cta_desc: '3 days free. No credit card. Cancel anytime.',
    per_month: '/month',
  ...
  fr: {
    ...
    features_title: 'Pourquoi Sovlo AI ?',
