...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Lead Arama — 1 kr/lead', included: true },
      { text: 'WhatsApp & E-posta — 1 kr/gönderim', included: true },
      { text: 'AI Mesaj Kişiselleştirme — 3 kr', included: true },
      { text: 'Ses Klonlama & Video Mesaj — kredi ile', included: true },
      { text: 'Pipeline CRM + Teklif/Fatura', included: true },
      { text: 'QR Üretici', included: true },
      { text: 'Ekip Yönetimi', included: false },
      { text: 'Sequence & Workflow Otomasyon', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'WhatsApp — 3 numara', included: true },
      { text: 'Email + SMS Kampanya', included: true },
      { text: 'Ses Klonlama (3 profil) + Video (2 avatar)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'WhatsApp — 15 numara', included: true },
      { text: 'Sınırsız Sequence & Workflow', included: true },
      { text: 'Ses Klonlama (10) + Video Avatar (5)', included: true },
      { text: 'AI Satış Koçu & Ekip Analizi', included: true },
      { text: 'API Erişimi (10K istek/gün)', included: true },
      { text: 'Ekip — 25 koltuk', included: true },
      { text: 'Öncelikli Destek 7/24', included: true },
      { text: 'White-Label', included: false },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Reveal>
          <div className="mt-8 p-5 bg-white rounded-2xl border border-slate-200 grid sm:grid-cols-4 gap-4">
            {[
              { label: 'Apollo + ElevenLabs + HeyGen + WA aracı', price: '~$200+/ay', bad: true },
              { label: 'Sovlo Growth — hepsi tek pakette', price: '$149/ay', bad: false },
              { label: 'Ses klonlama & video (kendi GPU altyapısı)', price: 'Dahil', bad: false },
